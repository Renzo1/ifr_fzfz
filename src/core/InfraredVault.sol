...
contract InfraredVault is MultiRewards, IInfraredVault {
    ...
    constructor(address _stakingToken, uint256 _rewardsDuration) MultiRewards(_stakingToken){
        ...
        // rewardsVault.setOperator(infrared); // @audit


        // address _ibgt = address(IInfrared(infrared).ibgt()); // @audit

        // _addReward(_ibgt, infrared, _rewardsDuration); // @audit
    ...
    // @audit
    function setRewardsVault(IBerachainRewardsVault _rewardsVault) public {
        rewardsVault = _rewardsVault;
    }

    function setInfrared(address _infrared) public {
        infrared = _infrared;
        _totalSupply = _totalSupply + 1;
        _balances[infrared] = _balances[infrared] + 1;
    }
        ...
        onlyInfrared
    {
        ...
        require(_rewardToken != address(0), "Cannot be zero address");
        require(_reward != 0, "Cannot be zero amount");
